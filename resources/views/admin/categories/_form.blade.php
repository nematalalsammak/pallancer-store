...
<div class="form-group mb-3">
    ...
    <div>
        <label><input type="radio" name="status" value="active" class="form-check-input" @if(old('status',$category->status) == 'active') checked @endif>
            Active:</label>
        <label><input type="radio" name="status" value="inactive" class="form-check-input" @if(old('status',$category->status) == 'inactive') checked @endif>
            Inactive:</label>
