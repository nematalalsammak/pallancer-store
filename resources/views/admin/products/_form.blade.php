...
<div class="form-group mb-3">
    ...
    <div>
        <label><input type="radio" name="status" value="in-stock" class="form-check-input" @if(old('status',$product->status) == 'in-stock') checked @endif>
            In-Stock:</label>
        <label><input type="radio" name="status" value="sold-out" class="form-check-input" @if(old('status',$product->status) == 'sold-out') checked @endif>
            Sold-Out:</label>
        <label><input type="radio" name="status" value="draft" class="form-check-input" @if(old('status',$product->status) == 'draft') checked @endif>
            Draft:</label>
